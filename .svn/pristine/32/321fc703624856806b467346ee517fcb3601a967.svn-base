...
Selection = (function(superClass) {
  ...
  Selection.prototype.breakBlockEl = function(el, range) {
    ...
    Selection.prototype.setSelectionSaved = function(data){
        this._selectionSaved = data;
    }

  Selection.prototype.save = function(range) {
    var endCaret, endRange, startCaret,beforeStart,beforeEnd;
    if (range == null) {
      range = this.range();
    }
    if (this._selectionSaved) {
        beforeStart = this.editor.body.find('.simditor-caret-start');
        beforeEnd = this.editor.body.find('.simditor-caret-end');
        beforeStart.remove();
        beforeEnd.remove();
        // return;
    }
  ...
  FontScaleButton.prototype.command = function(param) {
    ...
    $scales.each((function(_this) {
      return function(i, n) {
        ...
        if (/large|x-large|small|x-small|medium/.test(size)) {
